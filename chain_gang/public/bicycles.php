...
// this $args is the goal we want to creat an array similar it it 
// and we make it with parseing CSV file 
  // $args =['brand' => 'Trek','model' => 'Emonda','year' => 2017,'gender' => 'Unisex','color' => 'black',
  //         'category' => 'Road','weight_kg' =>1.5,'price' => 1000.00];

  // for price format 
  // $bike_price = new NumberFormatter( 'en_US', NumberFormatter::CURRENCY );
  // echo h($bike_price->formatCurrency($bike->price, "US")); 
